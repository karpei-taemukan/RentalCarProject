					...
					<div class="section_list">
						...
						<div class="cs_content">
							...
							<div class="list_board">
								<div class="board card">
									<table style="margin-top: 10px; margin-bottom: 10px;">
										...
										<tbody class="boardTableBody">
											<c:forEach var="blist" items="${boardlist }" begin="${(param.page-1)*10}"
												end="${(param.page-1)*10+9}" step="1" varStatus="status">
												<tr>
											...
											<ul class="pagination">
												<c:if test="${nowPageList > 1}">
													<li class="page-item"><a class="page-link"
															href="${pageContext.request.contextPath}/noticeMove?page=${(nowPageList-2)*10+1}"
												...
												<c:forEach var="pageCount" begin="${(nowPageList-1)*10+1 }"
													...
													<li class="page-item"><a class="page-link"
															href="${pageContext.request.contextPath}/noticeMove?page=${pageCount}">${pageCount
															}</a></li>
												</c:forEach>
												<c:if test="${nowPageList*10 < boardListCount}">
													<li class="page-item"><a class="page-link"
															href="${pageContext.request.contextPath}/noticeMove?page=${nowPageList*10+1}"
								...
								<c:choose>
									<c:when test="${state == 'AD' }">
										<div class="boardWriteBtn">
											<a href="${pageContext.request.contextPath}/noticeWriteMove"
