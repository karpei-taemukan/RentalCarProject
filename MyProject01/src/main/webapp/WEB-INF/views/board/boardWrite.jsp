...
<html lang="en">
        ...
        <div class="sub_main">
			...
			<div class="sub_container">
				<div class="board_wrap">
					<form action="${pageContext.request.contextPath}/boardWriteInsert" onsubmit="return formCheck(this);">
						<h3>글 작성</h3>
						<div class="bttm-box">
							<ul id="board_view">
								<li class="title_area">
									<input type="text" placeholder="제목을 입력해주세요" id="boardTitle" name="btitle">
								</li>
								<li class="edit_area">
									<textarea name="bcontents" id="boardTextArea" placeholder="글을 입력해주세요"></textarea>
								</li>
							</ul>
						</div>
						<div class="boardWriteBtn">
							<a class="mx-2 btn btn-warning" href="${pageContext.request.contextPath}/boardmove?page=1">글 목록</a>
							<button type="submit" class="writeBtn btn btn-success">글 작성</button>
						</div>
					</form>
				</div>
			</div>
	...
	function formCheck(obj) {
        ...
        let title = obj.btitle  // 아이디 입력 input태그
        let titlearea = obj.bcontents  // 비밀번호 입력 input태그
